  ...
  return (
    <div className="relative">
      ...
      <img
        ...
        alt=""
      />
      <div className="relative bg-opacity-75 backgroundMain" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1534156039819-c89418369a4f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
        <svg
          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                D-CROWDFUNDING <br className="hidden md:block" />
              </h2>
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                Web3-based crowdfunding platform
              </p>
              <a
                href="/"
                aria-label=""
